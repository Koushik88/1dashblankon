...
class SocialStream
{
    ...
    public function init($attr, $echo = true, $args = null, $ajax_feed = array(), $loadmore = array())
    {
                    ...
                    foreach ($feeds2 as $ifeed => $feed) {
                        ...
                        elseif ($feed_class == 'instagram') {
                            ...
                            if (@$feed) {
                                ...
                                <span class="sb-text">
                                    <span class="sb-meta">
                                        <span class="likes"><i class="sb-bico sb-thumbs-up"></i><bold style="position: relative;top: -2px;padding-left: 2px;">' . @$connections->likes->total . '</bold></span>
                                        <span class="views"><i class="sb-bico sb-play-circle"></i><bold style="position: relative;top: -2px;padding-left: 2px;">' . @$item->stats->plays . '</bold></span>
                                        <span class="comments"><i class="sb-bico sb-comment"></i><bold style="position: relative;top: -2px;padding-left: 2px;">' . @$connections->comments->total . '</bold></span>
                                        <span class="duration"><i class="sb-bico sb-clock-o"></i><bold style="position: relative;top: -2px;padding-left: 2px;">' . @$item->duration . ' secs </bold></span>
                                    </span>
                                </span>';
            ...
            case 'youtube':
                ...
                */
                foreach ($feed->items as $key => $value) {
                   $stat_url = "https://www.googleapis.com/youtube/v3/videos?id=".$value->snippet->resourceId->videoId."&part=statistics&key=".$google_api_key;
                   $stat = (!$forceCrawl) ? $cache->get_data($stat_url, $stat_url) : $cache->do_curl($stat_url);
                   $stat    = @json_decode($stat);
                   $feed->items[$key]->statistics = @$stat->items[0]->statistics;                   
                }
                //-----------------
                // echo "<pre>";
                // print_r($feed);
