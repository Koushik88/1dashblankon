...
//$query = "entities=" . $entityString . "&changedSince=" . $formattedChangedSince;
		...
		//$uri = "company/{1}/cdc?{2}";
		$uri = "company/{1}/reports/AgedReceivables?{2}";
        ...
        print_r($responseArray);
         echo "</pre>";*/
       /*  echo "-----------";
function AgedReceivableReportUI($responseArray)
{
	echo "<h3>AgedReceivable Detail ".$responseArray['Header']['EndPeriod']."</h3>";
        echo "From Date:".$responseArray['Header']['StartPeriod']."&nbsp;&nbsp;&nbsp;To Date:".$responseArray['Header']['EndPeriod']."<br />";
              
        
       echo "<pre>";
       print_r($responseArray['Rows']['Row']); 
        echo "</pre>";
       // print_r($count);
	$i = 1;
