        ...
        <div class="tile">
                <h2 class="tile-title">Manage Users</h2>
                            ...
                            <div class="tile-config dropdown">
                                ...
                                <ul class="dropdown-menu  text-left" style="min-width:130px !important;">                                                    
                        ...
                        <div class="listview icon-list"> 
                            <div class="media">                                                
                                <div class="media-body"> 
                                    ...
                                    {if $licence_type["license_id"] neq '1'} <a href="#updateCardDetials" data-toggle="modal" class="btn btn-sm m-r-5 pull-right">Update Card</a> {/if}
                             ...
                             <div class="media">                                                
                                <div class="media-body"> 
                                     Number of Users : {if $licence_type["license_id"] eq '1'}  (0 of 0)  {else} (1 of {$NoOfLicenceUser}) {/if}
